        ...
        return (
            <div >
                <div id="header" className="logo">
                    ...
                    <div className="left-right-line-short-header">Подольский Вячеслав Ильич</div>
                    <div className="left-right-line-short-header1">P3220</div>
                    <div className="left-right-line-short-header2">Вариант 20016</div>
                </div>
