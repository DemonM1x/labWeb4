        ...
        return(
            <div className="frame2">
                <svg width="500" height="400" className="svg-graph" id="svg">
                    ...
                    <rect x="150" y="150" width="100" height="100" fill="#cdc684" stroke="#cdc684" fillOpacity="0.3" />
                    <polygon points="150,150 100,150 150,50" fill="#cdc684" stroke="#cdc684" fillOpacity="0.3"></polygon>
                    <path d="M 150 200 A 50 50, 180, 0, 1, 100 150 L 150 150 Z" fill="#cdc684" stroke="#cdc684" fillOpacity="0.3"></path>
